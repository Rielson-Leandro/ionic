...
export class LoginProvider {
  ...
  loginFalhaEventEmitty:EventEmitter<any>;
  ...
  constructor(public http: Http, public ngZone: NgZone) {
    ...
    this.loginFalhaEventEmitty = new EventEmitter();
...
loginComFacebook(){
  //noinspection TypeScriptUnresolvedFuction
...
loginComGoogle(){
  ...
  private callbackFalhaLogin(error){
    this.loginFalhaEventEmitty.emit({code: error.code, message: error.message, email: error.email, credencial: error.credencial});
